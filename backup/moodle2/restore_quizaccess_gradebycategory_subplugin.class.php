...
/**
 * Provides the information to restore the gradebycategory quiz access plugin.
 *
 ...
 */
class restore_quizaccess_gradebycategory_subplugin extends restore_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $elepath = $this->get_pathfor('/quizaccess_gradebycategory');
    ...
    /**
     * Processes the quizaccess_gradebycategory element, if it is in the file.
     * @param array $data the data read from the XML file.
     */
    public function process_quizaccess_gradebycategory($data) {
        global $DB;

        $data = (object)$data;
        $data->quizid = $this->get_new_parentid('quiz');
        $DB->insert_record('quizaccess_gradebycategory', $data);
    }
}
